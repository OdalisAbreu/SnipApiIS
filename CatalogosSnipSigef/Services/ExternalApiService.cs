...
namespace CatalogosSnipSigef.Services
{
    public class ExternalApiService
    {
        ...
        // Obtener datos de fuentes de financiamiento
        public async Task<FuentesFinanciamientsResponse> GetFuentesFinamciamientoAsync(string url, string token)
        {
            var client = _httpClientFactory.CreateClient();
        ...
        public async Task<FuenteFinanciamientoResponse> GetFuenteFinamciamientoAsync(string url, string token)
        {
            var client = _httpClientFactory.CreateClient();
            ...
            var content = await response.Content.ReadAsStringAsync();
            return JsonSerializer.Deserialize<FuenteFinanciamientoResponse>(content, new JsonSerializerOptions
            {
                PropertyNameCaseInsensitive = true
            });
        }
        ...
        public async Task<FuenteExterna> GetFuenteExternaAsync(string url, string token)
        {
            var client = _httpClientFactory.CreateClient();
            ...
            var content = await response.Content.ReadAsStringAsync();
            return JsonSerializer.Deserialize<FuenteExterna>(content, new JsonSerializerOptions
            {
                PropertyNameCaseInsensitive = true
            });
        }
