    ...
    public class FasesController : Controller
    {
        ...
        public async Task<IActionResult> ObtenerFases()
        {
           ...
           /* var query = @"
            ...
            var query = " SELECT dominio_sec, dominio_sig FROM refcodes WHERE dominio = 'fichas_proyectos.fase_actual'";
            ...
            {
                id_fase = f.dominio_sec,
                des_fase = f.dominio_sig,
                flg_habilitado = true // Validar el campo
            }).ToList();
